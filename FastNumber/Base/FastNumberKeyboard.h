...
//! Project version number for FastNumberKeyboard.
FOUNDATION_EXPORT double FastNumberKeyboardVersionNumber;

//! Project version string for FastNumberKeyboard.
FOUNDATION_EXPORT const unsigned char FastNumberKeyboardVersionString[];

@class FastNumberKeyboard;

/**
 *  The @c FastNumberKeyboardDelegate protocol defines the messages sent to a delegate object as part of the sequence of editing text. All of the methods of this protocol are optional.
 */
@protocol FastNumberKeyboardDelegate <NSObject>
@optional
 ...
 */
- (BOOL)numberKeyboard:(FastNumberKeyboard *)numberKeyboard shouldInsertText:(NSString *)text;
 ...
 */
- (BOOL)numberKeyboardShouldDeleteBackward:(FastNumberKeyboard *)numberKeyboard;
 ...
 */
typedef NS_ENUM(NSUInteger, FastNumberKeyboardStyle) {
    /**
     ...
     */
    FastNumberKeyboardStyleAutomatic,
     ...
     */
    FastNumberKeyboardStylePlainButtons,
 ...
 */
@property (weak, nonatomic, nullable) id <FastNumberKeyboardDelegate> delegate;
 ...
 *
 *  @note The default style for the keyboard is @c FastNumberKeyboardStyleAutomatic.
 */
@property (assign, nonatomic) FastNumberKeyboardStyle preferredStyle;

/**
 *  The button style of the Return key.
 *
 *  @note The default value of this property is @c FastNumberKeyboardButtonStyleDone.
 */
@property (assign, nonatomic) FastNumberKeyboardButtonStyle returnKeyButtonStyle;
